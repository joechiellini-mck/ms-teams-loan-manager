# Loan Manager Bot - `loanManagerBot`
...
3. Give the bot a handle (ex: `loanManagerBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://.azurewebsites.net/api/messages`
